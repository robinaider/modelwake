...
## [0.2.0] - 2026-09-16
- Eval harness: `modelwake eval` grades tiers against your own JSONL suite (substring/regex, no judge model), logs to the ledger as `EVAL:<tier>`, exit 1 unless all pass.
